...
🔗 aldo377.github.io/HappyBirthday-AnggiDwiAprilia
...
Poppins (300, 400, 600, 800, 900) via Google Fonts

Warna Utama

#f8f9fa (background), #111111 (teks & border)
...
4px solid hitam di semua elemen

Shadow

Hard drop shadow (bukan blur) — ciri khas Brutalism
...
Buka link website di HP kamu

Klik tombol di Hello Screen untuk masuk

Pergi ke halaman Tutor dan baca aturan mainnya

Mainkan Misi 1 (Flappy Bird) → Screenshot clue username-nya

Mainkan Misi 2 (Game 2048) → Screenshot clue password-nya

Kembali ke halaman Login dan masukkan username & password

Selamat! Kado utama sudah terbuka! 🎉
...
Klik Save — website langsung live!
...
Made with ❤️ for Anggi Dwi Aprilia Happy Birthday, Princess 🎂✨
